                        ...
                        <div class="tab-pane fade active show" id="tab-form" role="tabpanel" aria-labelledby="tab-form">
                            <form data-option="{}" id="form" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <select class="form-control sel2" id="kdjentrx" name="kdjentrx" required>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <select class="form-control akunutama sel2" id="kdakunutama" name="kdakunutama"  required>
                                            </select>
                                        </div>
                                        <div class="col-6">
                                ...
                                <div class="text-right">
                                    <button type="submit" class="btn btn-primary" id="buttonsimpan" disabled="">Simpan</button>
                                </div>
                        </div>
                        </form>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        }).on('DOMNodeInserted', '.num', function(){
    ...
    function addrows(){
        var $row = $("<tr>");
        $row.append($("<td>"));
        $row.append($("<td>").html('<input type="hidden" name="id[]"><select class="form-control sel2 akun" name="kdakun[]"></select>'));
          if ($('#kdjentrx').val()==1) {
        ...
        numberRows($("#tb-perkiraan"));
          ...
          $(".akun").append($("<select class='asd'><select/>"));
          $(".num").append($('<input class="num">'));
