...
class Page extends MY_Controller
{
    ...
    function pembayaran_edit()
    {
        ...
        $query = "SELECT a.kdjentrx ,a.tgltrx, a.nobukti, a.ket, JSON_ARRAYAGG(JSON_OBJECT('idtrx', a.id, 'kd_akun', a.kdakun, 'nama_akun' , b.namaakun, 'debet' , a.d, 'kredit', a.k , 'is_parent' , a.is_parent) ) AS arr_akun FROM t_keuangan a LEFT JOIN m_akun b ON a.kdakun=b.kdakun WHERE a.nobukti='".$cekid->nobukti."' and a.is_deleted='0' and a.is_transaksi='1' GROUP BY a.nobukti ";
