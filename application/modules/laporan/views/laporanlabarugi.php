...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#pdf-download').on('click', function (e) {
            $(this).attr("href", "<?=base_url()?>laporan/pdf/laporanlabarugi?periode="+ $('#periode').val()+ "&periode_awal="+ $('#periode_awal').val() );
            $(this).attr("target", "_blank");
        });

        $('#pdfringkasan-download').on('click', function (e) {
            $(this).attr("href", "<?=base_url()?>laporan/pdf/laporanlabarugiringkasan?periode="+ $('#periode').val()+ "&periode_awal="+ $('#periode_awal').val() );
            $(this).attr("target", "_blank");
        });

        $('#excel-download').on('click', function (e) {
            $(this).attr("href", "<?=base_url()?>laporan/excel/laporanlabarugi?periode="+ $('#periode').val()+ "&periode_awal="+ $('#periode_awal').val() );
            $(this).attr("target", "_blank");
        });
