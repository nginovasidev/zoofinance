...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#excel-download').on('click', function (e) {
            $(this).attr("href", "<?=base_url()?>laporan/excel/laporanledgerdetail?periode_awal="+ $('#periode_awal').val()+"&periode_akhir="+ $('#periode_akhir').val()+"&kdakun="+ $('#idparent').val()+"");
            $(this).attr("target", "_blank");
        });
        ...
        $('#idparent').select2({
            ...
            allowClear: true,
            ajax: {
                url: '<?= base_url() ?>keuangan/ajaxfile/cariparent',
                dataType: 'json',
                method: 'POST',
                quietMillis: 100,
                data: function(param) {
