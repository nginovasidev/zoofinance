        ...
        <div class="card-body">
          <div class="tab-content">
              <div class="form-group">
                <div class="row">
                  <div class="col-6">
                      <label for="akunopname">Akun Opname</label>
                      <select class="form-control sel2" id="akunopname" name="akunopname" style="width: 100%" required>
                      </select>
                  </div>
                  <div class="col-6">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $(document).on('submit', '#forminput', function(e) {
          ...
          if ($("#akunopname").val()==null) {
              $("#akunopname").select2('open');
          } else {
        ...
        $('#akunopname').select2({
            placeholder: "Pilih akun opname",
            minimumInputLength: 0,
            multiple: false,
            allowClear: true,
            ajax: {
                url: url_ajax+'/cariakunopname',
                dataType: 'json',
                method: 'POST',
                quietMillis: 100,
                data: function(param) {
