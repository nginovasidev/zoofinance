                            ...
                            <table id="tb-perkiraan" class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th style="position:relative;">Perkiraan
                                            <div style="position:absolute;right:5px;top:5px;">
                                                <a id="add-service-button" data-original-title="Tambah Item Jurnal"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus mx-2">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th>
                                            <div class="text-right" id="tot_d"></div>
                                        </th>
                                        <th>
                                            <div class="text-right" id="tot_k"></div>
                                        </th>
                                        <th>
                                            <div class="text-right" id="notes"></div>
                                        </th>
                                    </tr>
                                </tfoot>
                            </table>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
                    ...
                    if (result.success) {
                        ...
                        obj.forEach(function(x) {
                            ...
                            if (x.is_parent == 0) {
                                ...
                                inputdelete += '<input type="hidden" name="is_deleted[' + urut + ']" value="' + x.idtrx + '">';
        ...
        $('#kdjentrx').select2({
            ...
            $('#idakunsecond').append(inputdelete);
    ...
    $(function() {
        $('body').on('DOMNodeInserted', '.akun:last', function() {
            ...
            $('.num:last').mask('000,000,000,000,000', {
                reverse: true
            });
        });
    });
    ...
    function hitungtotal() {
        ...
        if ($('#kdjentrx').val() == 1) {
            ...
            if (rubah(sum) == $("#kutama").val()) {
                if ($("#alert_nobukti text").html() == 'Nomor Bukti Sudah Digunakan') {
