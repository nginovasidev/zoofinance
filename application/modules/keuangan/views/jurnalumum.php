            ...
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    <form data-plugin="parsley" data-option="{}" id="form" autocomplete="off">
                                ...
                                <input type="hidden" class="form-control" id="idakunutama"  value="" required>
    ...
    $(document).ready(function() {
        ...
        $("#nobukti").keyup(function(){
            ...
            $.ajax({
                ...
                data:{ idakunutama:$("#idakunutama").val() , nobukti: $("#nobukti").val(), '<?=$this->security->get_csrf_token_name()?>':'<?=$this->security->get_csrf_hash()?>' },
