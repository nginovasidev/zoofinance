                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <select class="form-control sel2" id="idparent" name="idparent" required>
                                            </select>
                                        </div>
                                        <div class="col-6">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <select class="form-control sel2" id="normalbalance" name="normalbalance" required>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <select class="form-control sel2" id="posisi" name="posisi" required>
                                                <option value="">Pilih Balance</option>
