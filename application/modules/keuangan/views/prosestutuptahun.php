      ...
      <div class="card">
        <div class="card-body">
          <div class="tab-content">
              <div class="form-group">
                <div class="row">
                  <div class="col-6">
                    ...
                    <input type="text" class="form-control" name="tahun" placeholder="tahun" value="<?=date("Y")?>" readonly>
                  </div>
              ...
              <div class="text-left">
                <button id="lock" class="btn btn-primary">Tutup</button>
              </div>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $(document).on('submit', '#forminput', function(e) {
            ...
            Swal.fire({
                title: "Tutup Tahun ?",
                text: "Apa anda sudah yakin ingin menutup tahun",
                icon: "warning",
                showCancelButton: true,
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            Swal.close();
                            if (result.success) {
                                Swal.fire('Sukses', 'Berhasil Menutup Tahun', 'success');
